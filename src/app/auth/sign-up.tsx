...
console.log("SIGN UP LOADED");
      ...
      <SafeAreaView style={{ flex: 1, backgroundColor: "#F8F8FF" }}>
        ...
        >
          ...
          >
            ...
            >
              <Text style={{ fontSize: 28, color: "#1C1C1E", lineHeight: 32 }}>‹</Text>
            </TouchableOpacity>
  
            {/* Heading */}
            <Text className="text-[50px] font-bold text-[#1C1C1E] leading-tight mb-1">
              Create your account
            </Text>
            ...
            <View style={[styles.inputContainer, { marginTop: 12 }]}>
              ...
              <View style={styles.passwordRow}>
                ...
                >
                  <Text style={{ fontSize: 18, color: "#9090A8" }}>
  {showPassword ? "🙈" : "👁"}
</Text>
                </TouchableOpacity>
              </View>
  ...
  // ─── Social Icons (inline SVG-equivalent using Text/View) ────────────────────
  function GoogleIcon() {
    return (
      <View style={{ width: 24, height: 24 }}>
        {/* Using emoji as placeholder — replace with actual SVG or react-native-svg icon */}
